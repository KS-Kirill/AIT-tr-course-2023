...
public class StringAppl {
    public static void main(String[] args) {
        System.out.println("-------------------------");
        String str  = "Hello";
        char [] chars = {32, 'w', 'o', 'r', 'l', 'd'};//kod probela
        ...
        str = str.concat(str1); //analogie operation as previos, added "word" one more time
        ...
        for (int i = 0; i < str.length(); i++) {
            System.out.print(str.charAt(i) + " ");//печать по буквам
        }
        System.out.println();
        System.out.println("-----------------------");
