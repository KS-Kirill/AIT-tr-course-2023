...
public class StringPerformanceTest {
    ...
    public static void main(String[] args) {
        ...
        long t2 = System.currentTimeMillis(); //второй раз засекаем время
        ...
        str = stringBuilder.toString(); //возвращаем в строку
        t2 = System.currentTimeMillis(); //второй раз засекаем время
        System.out.println(t2 - t1); //столько времени прошло в миллисекундах
    }
}
