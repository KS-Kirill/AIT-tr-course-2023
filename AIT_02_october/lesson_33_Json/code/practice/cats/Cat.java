...
public class Cat implements Comparable <Cat> {
    ...
    //и возвращает целое число всегда. Если оно > 0, то объекты меняются местами, в остальных случаях оставляем как есть
    @Override
    public int compareTo(Cat o) {
        int res = this.age - o.age;//сравнили года: текущую кошку с Cat o
        return res;
    }
}
