...
//Поиск дубликатов - подход 2.
// Давайте упростим постановку задачи.
// Задан массив целых чисел.
// Создайте метод, который возвращает количество повторов заданного элемента в массиве.
public class ArrayMethod3 {

    // поиск заданного дубликата
    public static int searchDublicate (int[] arr, int num) {
        int count = 0;
